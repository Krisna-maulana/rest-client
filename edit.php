...
$response = $client->request('GET', '/api/getId/', ['json' => [
    'id' => $id,
]]);
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <form action="edit_data.php?id=<?php echo $id?>" method="POST">
                        <div class="mb-3">
                            <label for="name_field" class="form-label">Alamat Kost</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jumlahkamar" id="jumlahkamar" class="form-control" value="<?php echo $data_body->jumlahkamar ?>"required></input>
                        </div>
                        <div class="mb-3">
