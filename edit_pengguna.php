...
$response = $client->request('GET', '/api/GetIdPengguna/', ['json' => [
    'id' => $id,
]]);
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <a href="pengguna.php" class="btn btn-secondary"><span class="material-icons-outlined">Kembali</span></a>
                            </div>
                        </div>
                    </div>
                    <form action="edit_data_pengguna.php?id=<?php echo $id?>" method="POST">
                        <div class="mb-3">
